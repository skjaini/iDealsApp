...
public class DealsHomeActivity extends FragmentActivity implements TabListener {
	...
	private void setupNavigationTabs() {
		...
		Tab tabHome = actionBar.newTab().setText("List").setTag("DealsListFragment").setIcon(R.drawable.ic_action_list).setTabListener( this);
		
		Tab tabMentions = actionBar.newTab().setText("Map").setTag("DealsMapFragment").setIcon(R.drawable.ic_action_map).setTabListener(this);
